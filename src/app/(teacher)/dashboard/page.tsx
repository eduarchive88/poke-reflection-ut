    ...
    const menuItems = [
        {
            ...
            icon: <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/up-grade.png" className="w-12 h-12" style={{ imageRendering: 'pixelated' }} alt="PC" />,
        ...
        },
        {
            ...
            icon: <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/town-map.png" className="w-12 h-12" style={{ imageRendering: 'pixelated' }} alt="Town map" />,
        ...
        },
        {
            ...
            icon: <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/exp-share.png" className="w-12 h-12" style={{ imageRendering: 'pixelated' }} alt="Exp share" />,
        ...
        },
        {
            ...
            icon: <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/vs-seeker.png" className="w-12 h-12" style={{ imageRendering: 'pixelated' }} alt="Gym" />,
            path: "/dashboard/gym",
        ...
        },
        {
            ...
            icon: <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/journal.png" className="w-12 h-12" style={{ imageRendering: 'pixelated' }} alt="Log" />,
            path: "/dashboard/logs",
                ...
                <div className="relative z-10 flex flex-col lg:flex-row justify-between items-center gap-12">
                    <div className="space-y-6 text-center lg:text-left">
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-black/30 border-[3px] border-black text-white text-[10px] font-black uppercase tracking-widest shadow-[2px_2px_0px_#000]">
                            <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/potion.png" className="w-4 h-4" style={{ imageRendering: 'pixelated' }} alt="PC Box" onError={(e) => e.currentTarget.style.display = 'none'} />
                    ...
                    <div className="grid grid-cols-2 gap-4 w-full lg:w-auto">
                        <Card className="retro-box p-4 bg-white dark:bg-slate-900 border-2 items-center flex flex-col justify-center min-w-[150px]">
                            <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/poke-ball.png" className="w-8 h-8 mb-2" style={{ imageRendering: 'pixelated' }} alt="Poke Ball" />
                        ...
                        <Card className="retro-box p-4 bg-white dark:bg-slate-900 border-2 items-center flex flex-col justify-center min-w-[150px]">
                            <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/great-ball.png" className="w-8 h-8 mb-2" style={{ imageRendering: 'pixelated' }} alt="Great Ball" />
                ...
                >
                    <Card className="retro-box h-full bg-slate-100 dark:bg-slate-800 p-8 flex flex-col relative overflow-hidden group">
                        ...
                        <div className="absolute top-0 right-0 p-6 opacity-[0.05] pointer-events-none group-hover:opacity-[0.1] transition-opacity">
                            <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/137.png" className="w-32 h-32" style={{ imageRendering: 'pixelated' }} alt="Porygon" onError={(e) => e.currentTarget.style.display = 'none'} />
                        </div>
                        <div className="relative z-10 flex flex-col h-full">
                            <div className="flex items-center gap-3 mb-8 border-b-[3px] border-black pb-4">
                                <div className="p-2 bg-white border-2 border-black shadow-[2px_2px_0px_#000]">
                                    <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/potion.png" className="w-6 h-6" style={{ imageRendering: 'pixelated' }} alt="Parts" onError={(e) => { e.currentTarget.src = 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/potion.png'; }} />
                                </div>
                            ...
                            <div className="mt-6 p-3 bg-white dark:bg-slate-900 border-[3px] border-black shadow-[2px_2px_0px_#000] flex items-center gap-3">
                                <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/journal.png" className="w-5 h-5" style={{ imageRendering: 'pixelated' }} alt="Journal" />
