                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                            <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/town-map.png" alt="Students" className="w-8 h-8 pixelated" />
                        </div>
                            ...
                            <Dialog open={isAddIndividualOpen} onOpenChange={setIsAddIndividualOpen}>
                                <DialogTrigger asChild>
                                    <Button className="h-12 flex-1 sm:flex-none px-6 retro-btn bg-amber-400 hover:bg-amber-300 text-black font-black flex items-center gap-2">
                                        <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/poke-ball.png" alt="Add" className="w-5 h-5 pixelated" />
                                        개별 추가
                                    </Button>
                                </DialogTrigger>
                                <DialogContent className="sm:max-w-[425px] retro-box bg-slate-100 p-6">
                                    <DialogHeader>
                                        <DialogTitle className="text-2xl font-black text-black uppercase flex items-center gap-2" style={{ fontFamily: '"NeoDunggeunmo", sans-serif' }}>
                                            <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/poke-ball.png" alt="" className="w-6 h-6 pixelated" />
                                            학생 개별 등록
                                        </DialogTitle>
                                        ...
                                        <DialogFooter>
                                            <Button type="submit" disabled={uploading} className="h-12 w-full retro-btn bg-amber-400 hover:bg-amber-300 text-black font-black flex items-center justify-center gap-2">
                                                {uploading ? (
                                                    ...
                                                    <>
                                                        <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/repel.png" alt="" className="w-5 h-5 pixelated" />
                                                        학생 저장
                                                    </>
                                                )}
                                            </Button>
                            ...
                            <Dialog open={isUploadOpen} onOpenChange={setIsUploadOpen}>
                                <DialogTrigger asChild>
                                    <Button className="h-12 flex-1 sm:flex-none px-6 retro-btn bg-emerald-400 hover:bg-emerald-300 text-black font-black flex items-center gap-2">
                                        <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png" alt="Upload" className="w-5 h-5 pixelated" />
                                        일괄 등록
                                    </Button>
                                </DialogTrigger>
                                <DialogContent className="sm:max-w-[425px] retro-box bg-slate-100 p-6">
                                    <DialogHeader>
                                        <DialogTitle className="text-2xl font-black text-black uppercase flex items-center gap-2" style={{ fontFamily: '"NeoDunggeunmo", sans-serif' }}>
                                            <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/potion.png" alt="" className="w-6 h-6 pixelated" />
                                            엑셀 명렬표 업로드
                                        </DialogTitle>
                                        <DialogDescription className="text-black font-bold bg-white/50 p-2 rounded border-2 border-slate-300 border-dashed mt-2">
                                    ...
                                    <div className="grid gap-6 py-6">
                                        <Button className="h-12 w-full retro-btn bg-slate-200 hover:bg-slate-300 text-black font-bold flex items-center gap-2" onClick={downloadTemplate}>
                                            <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/exp-candy-s.png" alt="" className="w-5 h-5 pixelated" />
                                            작성 양식 받기 (Excel)
                                        </Button>
                                    ...
                                    <DialogFooter>
                                        ...
                                        >
                                            {uploading ? (
                                                ...
                                                <>
                                                    <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/up-grade.png" alt="" className="w-5 h-5 pixelated" />
                                                    명단 일괄 등록하기
                                                </>
                                            )}
                                        </Button>
                ...
                <CardHeader className="bg-indigo-100 border-b-4 border-black p-4 sm:p-6">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                        <div className="flex items-center gap-3">
                            <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/pokedex.png" alt="Pokedex" className="w-10 h-10 pixelated" />
                            <div>
                ...
                <CardContent className="p-0 overflow-x-auto">
                    {loading ? (
                        <div className="p-24 text-center text-black font-black text-xl flex flex-col items-center justify-center gap-4">
                            <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/town-map.png" alt="Loading" className="w-12 h-12 pixelated animate-bounce" />
                        ...
                        <div className="text-center py-24 text-black font-bold border-4 border-dashed border-slate-300 rounded-xl bg-slate-50 m-6 flex flex-col items-center gap-4">
                            <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/poke-ball.png" alt="Empty" className="w-12 h-12 pixelated opacity-50 grayscale" />
